...
import com.hybris.training.constants.TrainingaddonConstants;



/**
 * This is the extension manager of the Trainingaddon extension.
 */
public class TrainingaddonManager extends GeneratedTrainingaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TrainingaddonManager.class.getName());
	 ...
	 */
	public static TrainingaddonManager getInstance()
	{
		return (TrainingaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
