...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			com.training.core.jalo.custom.TrainingEmailProcess.class,
			null,
			false,
			null,
			false
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_AbstractOrder_totalAmountPaid();
			
				single_createattr_TrainingEmailProcess_cart();
	...
	public void single_createattr_AbstractOrder_totalAmountPaid() throws JaloBusinessException
	{
	...
	public void single_createattr_TrainingEmailProcess_cart() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createEnumerationValues(
			...
			single_setAttributeProperties_AbstractOrder_totalAmountPaid();
			...
			single_setAttributeProperties_TrainingEmailProcess_cart();
				...
				setDefaultProperties(
					...
					null
						...
						public void single_setAttributeProperties_AbstractOrder_totalAmountPaid() throws JaloBusinessException
						{
							...
							setAttributeProperties(
								...
								null,
								customPropsMap,
								"trainingTotalAmountPaidHandler"
							);
						}
					
						public void single_setAttributeProperties_TrainingEmailProcess_cart() throws JaloBusinessException
						{
